var JsParser = require("./languages/javascript");
var CoffeeParser = require("./languages/coffee");
var TypescriptParser =require("./languages/typescript");
...
var AtomDocrAtom;
module.exports =
  AtomDocrAtom = (function() {

    function AtomDocrAtom() {
      var self = this;
      var settings = atom.config.get('atomdocr');
      this.editor_settings = settings;

      atom.config.observe('atomdocr', function() {
        self.update_config();
      });

      atom.commands.add('atom-workspace', 'atomdocr:parse-tab', function(event) {
        self.event = event;
        var regex = {
          // Parse Command
          'parse': /^\s*(\/\*|###)[*!]\s*$/,
      ...
      atom.commands.add('atom-workspace', 'atomdocr:parse-enter', function(event) {
        self.event = event;
        var regex = {
          // Parse Command
          'parse': /^\s*(\/\*|###)[*!]\s*$/,
      ...
      atom.commands.add('atom-workspace', 'atomdocr:parse-inline', function(event) {
        self.event = event;
      ...
      atom.commands.add('atom-workspace', 'atomdocr:join', function(event) {
        self.event = event;
      ...
      atom.commands.add('atom-workspace', 'atomdocr:reparse', function(event) {
        self.event = event;
      ...
      atom.commands.add('atom-workspace', 'atomdocr:wrap-lines', function(event) {
        self.event = event;
      ...
      atom.commands.add('atom-workspace', 'atomdocr:decorate', function(event) {
        self.event = event;
      ...
      atom.commands.add('atom-workspace', 'atomdocr:decorate-multiline', function(event) {
        self.event = event;
    ...
    AtomDocrAtom.prototype.update_config = function() {
      var settings = atom.config.get('atomdocr');
      this.editor_settings = settings;
    };
     ...
     */
    AtomDocrAtom.prototype.validate_request = function(options) {
      /**
    ...
    AtomDocrAtom.prototype.parse_command = function(inline) {
      var editor = atom.workspace.getActiveTextEditor();
    ...
    AtomDocrAtom.prototype.trim_auto_whitespace_command = function() {
      /**
    ...
    AtomDocrAtom.prototype.indent_command = function() {
      var editor = atom.workspace.getActiveTextEditor();
    ...
    AtomDocrAtom.prototype.join_command = function() {
      var editor = atom.workspace.getActiveTextEditor();
    ...
    AtomDocrAtom.prototype.decorate_command = function() {
      var editor = atom.workspace.getActiveTextEditor();
    ...
    AtomDocrAtom.prototype.decorate_multiline_command = function() {
      var editor = atom.workspace.getActiveTextEditor();
      var pos = editor.getCursorBufferPosition();
      var whitespace_re = /^(\s*)\/\*/;
    ...
    AtomDocrAtom.prototype.deindent_command = function() {
      /*
    ...
    AtomDocrAtom.prototype.reparse_command = function() {
    ...
    AtomDocrAtom.prototype.wrap_lines_command = function() {
      /**
    ...
    AtomDocrAtom.prototype.get_indent_spaces = function(editor, line) {
    ...
    AtomDocrAtom.prototype.initialize = function(editor, inline) {
    ...
    AtomDocrAtom.prototype.set_snippets_service = function(service) {
        this.snippets_service = service;
    };

    AtomDocrAtom.prototype.counter = function() {
      var count = 0;
      return (function() {
        return ++count;
      });
    ...
    AtomDocrAtom.prototype.repeat = function(string, number) {
      return Array(Math.max(0, number) + 1).join(string);
    };

    AtomDocrAtom.prototype.write = function(editor, str) {
      // will insert data at last cursor position
      if(this.snippets_service)
        this.snippets_service.insertSnippet(str, editor);
      else {
        atom.notifications.addFatalError('AtomDocr: Snippets package disabled.', {
          detail: 'Please enable Snippets package for AtomDocr to function properly.',
          dismissable: true,
          icon: 'flame'
        });
        if(self.event)
    ...
    AtomDocrAtom.prototype.erase = function(editor, range) {
      var buffer = editor.getBuffer();
      buffer.delete(range);
    };

    AtomDocrAtom.prototype.fill_array = function(len) {
      var a = [];
      var i = 0;
      while (i < len) {
        a[i] = 0;
    ...
    AtomDocrAtom.prototype.read_line = function(editor, point) {
    ...
    AtomDocrAtom.prototype.scope_range = function(editor, point, scope_name) {
    ...
    AtomDocrAtom.prototype.get_parser = function(editor) {
    ...
    AtomDocrAtom.prototype.generate_snippet = function(out, inline) {
    ...
    AtomDocrAtom.prototype.substitute_variables = function(out) {
    ...
    AtomDocrAtom.prototype.align_tags = function(out) {
    ...
    AtomDocrAtom.prototype.fix_tab_stops = function(out) {
      var tab_index = this.counter();
    ...
    AtomDocrAtom.prototype.create_snippet = function(out) {
      var snippet = '';
      var closer = this.parser.settings.commentCloser;
      var regex = /^\s*\*\s*`([a-zA-Z]+)|Return/;
      var i, len;
      if(out) {
