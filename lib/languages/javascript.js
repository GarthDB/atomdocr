...
JsParser.prototype.parse_function = function(line) {
    ...
    // assume underscore means private function
    var privateRegex = /^_/;
    var opts = {};
    if (matches.name1 && matches.name1.match(privateRegex)) opts.as_setter = true;
    if (matches.name2 && matches.name2.match(privateRegex)) opts.as_setter = true;
